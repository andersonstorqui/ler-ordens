...
import PricesList from '../../components/CaixaFisico/CaixaFisicoList';
class CaixaFisicoPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Page
				className="users"
				title="Caixa"
				breadcrumbs={[{ name: 'Caixa', active: true }]}>
...
// export default connect(mapStateToProps, mapDispatchToProps)(CaixaFisicoPage);
export default CaixaFisicoPage;

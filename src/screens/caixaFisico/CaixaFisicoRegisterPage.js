...
import Form from '../../components/CaixaFisico/CaixaFisicoRegisterForm';
...
class CaixaFisicoRegisterPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Page
				...
				parentBreadcrumbs="caixa"
				pathParent="/caixa"
				breadcrumbs={[
					{
						name: id ? 'Editar caixa' : 'Adicionar caixa',
						active: true,
					},
				]}>
				<LoadingContent
...
CaixaFisicoRegisterPage.propTypes = {
...
// export default connect(mapStateToProps, mapDispatchToProps)(CaixaFisicoRegisterPage);
export default CaixaFisicoRegisterPage;

...
import Form from '../../components/Faturamento/FaturamentoRegisterForm';
...
class FaturamentoRegisterPage extends React.Component {
	constructor(props) {
		super(props);
...
FaturamentoRegisterPage.propTypes = {
...
// export default connect(mapStateToProps, mapDispatchToProps)(FaturamentoRegisterPage);
export default FaturamentoRegisterPage;

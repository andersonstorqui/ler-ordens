...
class CaixaReceberRegisterPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Page
				...
				parentBreadcrumbs="conta-a-receber"
				pathParent="/conta/receber"
				breadcrumbs={[
					{
						name: id
...
CaixaReceberRegisterPage.propTypes = {
...
// export default connect(mapStateToProps, mapDispatchToProps)(CaixaReceberRegisterPage);
export default CaixaReceberRegisterPage;

...
import CaixaReceberList from '../../components/CaixaReceber/CaixaReceberList';

class CaixaReceberPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Page
				...
				breadcrumbs={[{ name: 'Conta a receber', active: true }]}>
...
// export default connect(mapStateToProps, mapDispatchToProps)(CaixaReceberPage);
export default CaixaReceberPage;

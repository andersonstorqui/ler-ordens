...
import Form from '../../components/PendenciasTable/PendenciasRegisterForm';
...
class PendenciasRegisterPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Page
				...
				parentBreadcrumbs="pendências"
				pathParent="/pendências"
				breadcrumbs={[
					{
						name: id ? 'Editar pendências' : 'Adicionar pendências',
						active: true,
					},
				]}>
				<LoadingContent
...
PendenciasRegisterPage.propTypes = {
...
// export default connect(mapStateToProps, mapDispatchToProps)(PendenciasRegisterPage);
export default PendenciasRegisterPage;

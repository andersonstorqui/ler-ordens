...
import PricesList from '../../components/PendenciasTable/PendenciasList';

class PendenciasPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		return (
			<Page
				className="users"
				title="Pendências"
				breadcrumbs={[{ name: 'Pendencias', active: true }]}>
...
// export default connect(mapStateToProps, mapDispatchToProps)(PendenciasPage);

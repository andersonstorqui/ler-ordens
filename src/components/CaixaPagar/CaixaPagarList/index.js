...
import StickyHeadTable from '../../Utils/TableContasPagar/Table';
import DataTable from '../../Utils/DataTable';

class CaixaPagarList extends React.Component {
	constructor(props) {
		super(props);
		...
		return (
			<div>
				...
				<Fab
					...
					event="click"
					icon={<MdAdd />}
					onClick={() => handleNavigation('/add/caixa/pagar')}
...
CaixaPagarList.defaultProps = {};

export default CaixaPagarList;
